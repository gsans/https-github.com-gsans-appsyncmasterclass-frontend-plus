<template>
  <div class="w-1/6 md:w-1/5 border-r border-lighter lg:px-6 py-2 flex flex-col justify-between">
    <div>
      ...
      <div>
        <button 
          ...
          class="focus:outline-none hover:text-blue flex items-center px-4 py-2 hover:bg-transparent md:hover:bg-lightblue rounded-full mr-auto mb-3">
          <i class="text-2xl mr-4" :class="tab.icon"></i>
          <p class="text-lg font-semibold text-left hidden lg:block"> {{ tab.title }}</p>
        </button>
      </div>
      <button class="text-white bg-blue rounded-full font-semibold h-12 lg:h-auto w-full hover:bg-darkblue p-3">
